...
void drawCube(bool cullback){
	...
	glBegin(GL_QUADS);
	glNormal(NORMAL_PACK(floattov10(-1.000000),floattov10(-0.000000),floattov10(-0.000000)));
	...
	glEnd();
	glBegin(GL_QUADS);
	glNormal(NORMAL_PACK(floattov10(-0.000000),floattov10(-0.000000),floattov10(-1.000000)));
	glVertex3v16(floattov16(0.000000), floattov16(0.000000), floattov16(-2.000000));
	...
	glEnd();
	glBegin(GL_QUADS);
	glNormal(NORMAL_PACK(floattov10(-0.000000),floattov10(-1.000000),floattov10(-0.000000)));
	glVertex3v16(floattov16(0.000000), floattov16(0.000000), floattov16(-2.000000));
